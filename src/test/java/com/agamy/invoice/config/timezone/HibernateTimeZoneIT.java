package com.agamy.invoice.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.agamy.invoice.IntegrationTest;
import com.agamy.invoice.repository.timezone.DateTimeWrapper;
import com.agamy.invoice.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM inv_date_time_wrapper where id=%d", fieldName, id);
    }
